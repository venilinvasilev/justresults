    ...
    return (
        <div className="col-3 d-flex justify-content-end">
            ...
            <div className={dropDown}>
                <Link className={styles.linkItem} to="/articles">
                    Articles
                </Link>
                {userAuth.loggedIn ? (
                    <Link className={styles.linkItem} to="/create-article">
                        Write an Article
                    </Link>
                ) : (
                    ''
                )}
                <Link className={styles.linkItem} to="/supplements">
                    Supplements
                </Link>
                {userAuth.role === 'admin' && (
                    <Link className={styles.linkItem} to="/add-supplement">
                        Add Supplement
                    </Link>
                )}
                <Link className={styles.linkItem} to="/calculator">
                    Calculator
                </Link>
                {!userAuth.loggedIn ? (
                    <div>
                        <Link className={styles.linkItem} to="/login">
                            Login
                        </Link>
                    ...
                    <Fragment>
                        ...
                        <Link className={styles.linkItem} onClick={handleLogout} to="/">
                            Logout
                        </Link>
                    </Fragment>
                )}
